                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('admin.products.update', $product->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mt-4">
                            ...
                            @if ($product->image)
                                <div class="mt-2">
                                    <h4 class="font-semibold text-sm mb-1">Current Image:</h4>
                                    {{-- Uses the symbolic link "storage" created earlier --}}
                                    <img src="{{ asset('storage/' . $product->image) }}" alt="{{ $product->name }}" class="w-32 h-32 object-cover border rounded shadow">
                                </div>
                            @endif
                        </div>
                        <div>
